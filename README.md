...
| [**pre-dispatch-schema-probe**](plugins/agent-traffic-control/skills/pre-dispatch-schema-probe/) | Probe the warehouse for the dataset paths, table names and column names a scope doc asserts, before a long or costly dispatch trusts them. |
